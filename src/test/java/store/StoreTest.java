...
public class StoreTest {
    ...
    @Test
    @DisplayName("프로모션 기간 아닐 때 재고관리 - 일반재고밖에 없을 때 일반재고를 올바르게 감소시킬 수 있다.")
    ...
    @Test
    @DisplayName("프로모션 기간 아닐 때 재고관리 - 프로모션 혜택이 가능한 상품이지만 기간이 아닐 때 일반재고를 우선 감소시킬 수 있다.")
    ...
    @Test
    @DisplayName("프로모션 기간일 때 재고관리 - 1개 수량을 추가 결제할 때 프로모션 재고를 올바르게 감소시킬 수 있다.")
    ...
    @DisplayName("프로모션 기간일 때 재고관리 - 정가로 결제해야 하는 수량을 결제하지 않을 때 올바르게 재고를 감소시킬 수 있다.")
    @ParameterizedTest
    ...
    @DisplayName("프로모션 기간일 때 재고관리 - 정가로 결제해야 하는 수량을 결제할 때 올바르게 재고를 감소시킬 수 있다.")
    @ParameterizedTest
    @CsvSource(value = {"[오렌지주스-9],9,0,2", "[오렌지주스-10],10,0,1"})
    void shouldDecreaseWhenPurchaseOriginalPrice(String name, int expectedTotalPurchase, int expectedPromotionQuantity, int expectedNormalPurchase) {
        Order order = new Order(name, store);
    ...
    @Test
    @DisplayName("프로모션 기간일 때 재고관리 - 추가로 물어볼 필요가 없는 주문일 때 재고를 올바르게 감소시킬 수 있다.")
